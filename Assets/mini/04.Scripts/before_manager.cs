...
public class before_manager : MonoBehaviour {

    public static before_manager instance;
    public Sprite[] img_game = new Sprite[3];
    ...
    void Awake()
    {
        ...
        if (before_manager.instance == null)
        {
            before_manager.instance = this;
        }
    }
}
